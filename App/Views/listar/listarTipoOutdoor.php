...
<head>
    ...
    <link rel="stylesheet" href="../../Content/css/listarTipoOutdoor.css">
    <script src="../../script/bootstrap/js/bootstrap.min.js"></script>
    <script src="../../script/bootstrap/js/jquery.min.js"></script>
    <title>Tipo de Outdoors</title>
</head>
<body class="body">
<header>
    <div class="logo-nav">
        ...
        <nav>
            <ul class="link-navigation">
                ...
                <li>
                    <a href="./listarOutdooresDesponivel.php">
  ...
  <script src="../../script/custom/listarTipoOutddoor.js"></script>
