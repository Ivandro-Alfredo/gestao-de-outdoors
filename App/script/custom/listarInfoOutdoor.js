document.addEventListener("DOMContentLoaded", function() {
  ...
  function obterTodosDados() {
    fetch('../../Controllers/outdoorController.php?action=consultarPrecoOutdoor')
  ...
  function preencherCampos(data) {
    cardContainer.innerHTML = ''; // Limpar os dados existentes
    ...
    data.forEach((outdoor, index) => {
      ...
      titulo.textContent = "Preço do Outdoor";
      cardBody.appendChild(titulo);

      const preco = document.createElement("p");
      preco.classList.add("card-text");
      preco.textContent = "Preço: " + outdoor.preco +" AOA";
  ...
  function openModal(outdoor) {
    ...
    modalBody.innerHTML = `
      <p><strong>Preço:</strong> ${outdoor.preco} AOA</p>
